    ...
    <div class="mx-auto max-w-2xl rounded-2xl border border-amber-200 bg-white p-8 shadow print:shadow-none print:border-0">
      ...
      <div v-else>
        ...
        <div class="mt-8 flex justify-between">
          ...
          <NuxtLink to="/marketplace" class="rounded-lg border border-amber-200 px-4 py-2 text-sm font-semibold text-amber-800 hover:bg-amber-50 print:hidden">Volver al marketplace</NuxtLink>
        </div>
      </div>
    </div>
  </div>
